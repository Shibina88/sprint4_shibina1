...
public class MainPage {
    ...
    private final By cookiesBtnLoc = By.xpath("//button[text()='да все привыкли']"); // локатор кнопки принятия куки
    private final By clickCreateOrderBtnLoc = By.xpath("//div[contains(@class,'Header')]/button[text()='Заказать']"); //кнопка Заказать верхнего блока
    private final By clickFooterCreateOrderBtnLoc = By.xpath("//div[contains(@class,'Home')]/button[text()='Заказать']"); //кнопка заказать в нижнем блоке
